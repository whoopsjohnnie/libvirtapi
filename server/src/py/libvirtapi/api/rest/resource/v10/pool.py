...
from libvirtapi.dao.pool import PoolDao
...
# PoolsResource
# 
class PoolsResource(DefaultResource):

    def dao(self, driver, hypervisor):
        return PoolDao(driver, hypervisor)
...
# PoolResource
# 
class PoolResource(DefaultResource):
    ...
    def put(self, driver, hypervisor, name):
        ...
        try:
            ...
            if not body:
                return self.bad("No pool JSON definition found", request)
